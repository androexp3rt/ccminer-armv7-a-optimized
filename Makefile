...
host_triplet = armv7a-unknown-linux-android24
target_triplet = armv7a-unknown-linux-android24
...
LDFLAGS = -v -flto -Wl,-z,relro,-z,now
...
dvidir = ${docdir}
exec_prefix = ${prefix}
host = armv7a-unknown-linux-android24
host_alias = armv7a-linux-android24
host_cpu = armv7a
host_os = linux-android24
host_vendor = unknown
htmldir = ${docdir}
...
ccminer_CPPFLAGS =  -I/data/data/com.termux/files/usr/include -fopenmp $(CPPFLAGS) \
	$(PTHREAD_FLAGS) -march=armv7-a -flax-vector-conversions \
	-fno-strict-aliasing $(JANSSON_INCLUDES) $(DEF_INCLUDES) -O3 \
	$(am__append_2)
